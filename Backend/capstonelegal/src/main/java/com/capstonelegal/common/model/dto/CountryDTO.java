...
public class CountryDTO implements Serializable {
     ...
     * @return a CountryDTO object with corresponding fields from the Country entity
     */
    public static CountryDTO fromCountryEntity(Country country){
        CountryDTO countryDTO = null;
        if(country != null){
            countryDTO = new CountryDTO(country.getCountryId(), country.getCountryName(), country.getCountryInitials());
        }
        return countryDTO;
    }
}
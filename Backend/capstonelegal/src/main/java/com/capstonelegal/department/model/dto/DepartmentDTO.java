package com.capstonelegal.department.model.dto;
...
public class DepartmentDTO implements Serializable {
    ...
    public static DepartmentDTO fromEntity(Department department){
        return new DepartmentDTO(department.getDepartmentId(), department.getDepartmentName(), department.getDepartmentDescription());
    }
}